...
import { listRecentLanguageFeedback } from "@/lib/data/language-feedback";
...
export default async function AdminPartnersPage() {
  ...
  const [{ partners, missingServiceRole }, settingsRate, languageFeedback] =
    await Promise.all([
