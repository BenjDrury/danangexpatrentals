...
export function StickyAreaCta({ areaId, areaName }: StickyAreaCtaProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-line bg-white/95 py-3 shadow-[0_-4px_12px_rgba(0,0,0,0.06)] backdrop-blur-sm">
      <div className="content-band flex flex-wrap items-center justify-center gap-3">
        <Link
          href={contactHref}
          onClick={() =>
            capture("area_cta_clicked", {
              area_id: areaId,
              area_name: areaName,
              source: "sticky_cta",
            })
